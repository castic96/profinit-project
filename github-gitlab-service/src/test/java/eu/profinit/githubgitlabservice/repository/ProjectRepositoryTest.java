...
class ProjectRepositoryTest {
    ...
    void shouldFindProjectsByUser() {
        ...
        Source source1 = sourceRepository.findByName(SourceEnum.GITHUB)
                .orElseThrow(() -> new IllegalStateException("Source not found in DB"));
        Source source2 = sourceRepository.findByName(SourceEnum.GITLAB)
                .orElseThrow(() -> new IllegalStateException("Source not found in DB"));
